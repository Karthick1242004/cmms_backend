...
const MaintenanceChecklistItemSchema = new Schema<IMaintenanceChecklistItem>(
  {
    description: {
      type: String,
...
const MaintenancePartSchema = new Schema<IMaintenancePart>(
  {
    partId: {
      type: String,
...
MaintenanceScheduleSchema.set('toJSON', {
  transform: function(doc: any, ret: any) {
    ...
    if (ret.parts) {
      ret.parts = ret.parts.map((part: any) => {
        part.id = part._id;
        delete part._id;
