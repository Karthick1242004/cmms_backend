...
export interface ITicket extends Document {
  _id: string;
  ticketId: string; // Auto-generated unique ticket ID
  priority: 'Low' | 'Medium' | 'High' | 'Critical';
  loggedDateTime: Date;
  loggedBy: string; // User ID or name who logged the ticket
  reportedVia: 'Phone' | 'Email' | 'In-Person' | 'Mobile App' | 'Web Portal';
  company: string;
  department: string; // Department responsible for the ticket
  area: string;
  inCharge: string; // Person in charge
  equipmentId?: string; // Asset ID (optional, can be general ticket)
  reviewedBy?: string;
  ...
  assignedDepartments: string[]; // Departments that can view this ticket
  assignedUsers: string[]; // Specific users assigned to this ticket
